 ...
 *
 * For this example to work, you really just need to configure AWS_IOT_MQTT_HOST, and
 * the AWS_IOT_MQTT_CLIENT_ID.
 */
...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "<Your MQTT Host Here>" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "<Your MQTT Client ID Here>" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "NBTutorial Device Name" ///< Thing Name of the Shadow this device is associated with
// =================================================
