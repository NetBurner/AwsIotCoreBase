 ...
 */
typedef struct {
	char *pDevicePublicKey;            ///< Pointer to string containing the filename (including path) of the device certificate.
	char *pDevicePrivateKey;           ///< Pointer to string containing the filename (including path) of the device private key file.
